...
export class EditCommentController implements WebController {
  constructor (private readonly editCommentUseCase: UseCase) {}
  ...
  async handle (req: HttpRequest): Promise<HttpResponse> {
    try {
      ...
      const response = await this.editCommentUseCase.execute({
