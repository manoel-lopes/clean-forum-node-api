...
const answerWithRelationsSchema = answerSchema.extend({
...
const questionWithRelationsSchema = questionSchema.extend({
  answers: paginatedItemsSchema(answerWithRelationsSchema).optional(),
...
export const getQuestionBySlugResponsesSchema = {
  200: questionWithRelationsSchema,
