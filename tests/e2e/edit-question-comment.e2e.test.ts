...
import { editQuestionComment, fetchQuestionComments } from '../helpers/comment-helpers'
import {
  commentOnQuestion,
  createQuestion,
  fetchQuestions
...
describe('Edit Question Comment Route', () => {
  ...
  it('should return 400 when content is missing', async () => {
    const httpResponse = await editQuestionComment(app, authToken, commentId, {})
  ...
  it('should return 404 when trying to edit non-existent comment', async () => {
    ...
    const httpResponse = await editQuestionComment(app, authToken!, fakeCommentId!, {
  ...
  it('should return 403 when trying to edit comment as non-author', async () => {
    const httpResponse = await editQuestionComment(app, otherUserToken, commentId, {
      content: 'Updated content'
    })
